...
## Financial Reconciliation & Exception Detection Engine

LedgerLens is a rule-based financial reconciliation system designed to compare payment, settlement, and bank transaction records, identify reconciliation exceptions, classify their causes, and route ambiguous transactions for human review.
